...
model_file = model_dir / "department_model.pkl"
vectorizer_file = model_dir / "department_vectorizer.pkl"
...
y_valid = validation_df["Department"]
...
print("\n" + "=" * 60)
print("DEPARTMENT MODEL PERFORMANCE")
print("=" * 60)
